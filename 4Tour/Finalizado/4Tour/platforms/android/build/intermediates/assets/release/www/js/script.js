var app = {
	...
	integracao: function(){
		document.getElementById('find_cep').addEventListener("click", function(){
			var cep = document.getElementById("field_cep").value;
			var info_cep = document.getElementById("info_find_cep");
			...
			$.get("http://apps.widenet.com.br/busca-cep/api/cep.json", { code: cep },
				function(result){
					...
					info_cep.innerHTML = 	"<strong>Endereço:</strong> "+result.address+
											"<br/><strong>Bairro:</strong> "+result.district+
											"<br/><strong>Cidade:</strong> "+result.city+
											"<br/><strong>Estado:</strong> "+result.state;
				}
			);
		});
	}
