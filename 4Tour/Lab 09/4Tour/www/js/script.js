	...
	mediaCapture: function(){
		...
		document.getElementById("capture_audio").addEventListener("click", function(){
			navigator.device.capture.captureAudio(
				...
				function (e) {
					put_audio.innerHTML = "Error getting audio." + JSON.stringify(e);
				},
				{ limit: 2 }
			);
		}, false);
		...
		document.getElementById("capture_picture").addEventListener("click", function(){
			navigator.device.capture.captureImage(
				...
				function (e) {
					put_foto.innerHTML = "Error getting picture." + JSON.stringify(e);
				},
				{ limit: 2 }
			);
		}, false);
		...
		document.getElementById("capture_video").addEventListener("click", function(){
			navigator.device.capture.captureVideo(
				...
				function (e) {
					put_video.innerHTML = "Error getting video." + JSON.stringify(e);
				},
				{ limit: 2, duration: 15 }
			);
		}, false);
